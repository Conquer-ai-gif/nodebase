    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://nodebase-4s.sentry.io/issues/?project=4510818218213376">Issues Page</a>.
